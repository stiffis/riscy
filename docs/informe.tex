...
\author{Steve Ildefonso \\ \texttt{steve.ildefonso@utec.edu.pe}}
\date{CS3051 -- Arquitectura de Computadores 2025-II \quad\textbar\quad HW\#6, Tarea 4}
...
por paso, que es exactamente la semántica arquitectónica del repertorio. La
microarquitectura (single-cycle, multiciclo o segmentado) es irrelevante para el
resultado y no se modela aquí.
